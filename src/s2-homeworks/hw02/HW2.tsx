...
export const deleteAffair = (affairs: AffairType[], _id: number): AffairType[] => { // need to fix any
    if (_id === 1) return (affairs.filter(a=>a._id !== 1))
    if (_id === 2) return (affairs.filter(a=>a._id !== 2))
    if (_id === 3) return (affairs.filter(a=>a._id !== 3))
    if (_id === 4) return (affairs.filter(a=>a._id !== 4))
    if (_id === 5) return (affairs.filter(a=>a._id !== 5))
    return affairs // need to fix
}
